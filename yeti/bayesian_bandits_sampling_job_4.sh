...
# Directives
#PBS -N bayesian_bandits_sampling_job_4
...
# Run script
python $PBS_O_INITDIR/../scripts/evaluate_bayesian_bandits_sampling_dynamic.py -M 1000 -K 3 -t_max 1500 -R 5000 -theta 0.6 0.7 0.9
