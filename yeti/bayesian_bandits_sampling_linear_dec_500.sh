...
# Directives
#PBS -N bayesian_bandits_sampling_linear_dec_500
...
# Run script
python $PBS_O_INITDIR/../scripts/evaluate_bayesian_bandits_sampling_linear_dec.py -K 2 -t_max 500 -R 1000 -theta_diff 0.1
