...
def main(A, t_max, M, N_max, R, exec_type, theta, d_context, type_context):
    ...
    bandits_colors=[colors.cnames['black'], colors.cnames['red'], colors.cnames['blue'], colors.cnames['green'], colors.cnames['yellow'], colors.cnames['cyan'], colors.cnames['purple'], colors.cnames['saddlebrown']]
...
if __name__ == '__main__':
    # Input parser
    # Example: python3 -m pdb evaluate_logistic_MCBandit_all.py -A 2 -t_max 10 -M 50 -N_max 20 -R 2 -exec_type batch -d_context 2 -type_context randn -theta 1 1 -1 -1 
    parser = argparse.ArgumentParser(description='Evaluate Contextual Logistic Bandits: TS, truncated Gaussian arm sampling and BUCB policies.')
