...
if __name__ == '__main__':
    # Input parser
    # Example: python3 -m pdb evaluate_ContextualLinearGaussianMixture_BanditSampling_TS.py -A 2 -K 2 -t_max 10 -R 2 -exec_type sequential -d_context 2 -type_context randn -pi 0.5 0.5 0.1 0.9 -theta 1 1 0 0 -1 -1 2 2 -sigma 1 1 1 1 -prior_K 2
