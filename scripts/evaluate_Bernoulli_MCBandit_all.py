...
def main(A, t_max, M, N_max, R, exec_type, theta):
    ...
    ############################### MAIN CONFIG  ############################### 
    print('{}-armed Bernoulli bandit with TS, arm sampling policies with {} MC samples and BUCB for {} time-instants and {} realizations'.format(A, M, t_max, R))
    ...
    bandits_colors=[colors.cnames['black'], colors.cnames['purple'], colors.cnames['skyblue'], colors.cnames['cyan'], colors.cnames['blue'], colors.cnames['red'], colors.cnames['chocolate'], colors.cnames['green'], colors.cnames['orange'], colors.cnames['yellow']]
...
if __name__ == '__main__':
    # Input parser
    # Example: python3 -m pdb evaluate_Bernoulli_MCBandit_all.py -A 2 -t_max 10 -M 50 -N_max 20 -R 2 -exec_type sequential -theta 0.2 0.5
    parser = argparse.ArgumentParser(description='Evaluate Bernoulli Bandits and MC: TS, truncated Gaussian arm sampling and BUCB policies.')
