...
def main(A, K, t_max, R, exec_type, pi, theta, sigma, d_context, type_context, prior_K, mixture_expectations):
    ...
    ############################### MAIN CONFIG  ############################### 
    print('{}-armed Contextual Linear Gaussian mixture bandit with optimal and sampling policies with MCMC-nonparametric and Variational inference for {} time-instants and {} realizations'.format(A, t_max, R))
...
if __name__ == '__main__':
    # Input parser
    # Example: python3 -m pdb evaluate_linearGaussianMixture_BanditSampling_VariationalVsNonparametric.py -A 2 -K 2 -t_max 10 -R 2 -exec_type sequential -d_context 2 -type_context randn -pi 0.5 0.5 0.1 0.9 -theta 1 1 0 0 -1 -1 2 2 -sigma 1 1 1 1 -prior_K 2 -mixture_expectations pi_expected
    parser = argparse.ArgumentParser(description='Evaluate Contextual Linear Gaussian Mixture Bandits: MCMC-nonparametric and Variational inference with sampling policy.')
