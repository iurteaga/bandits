...
def main(A, K, t_max, R, exec_type, pi, theta, sigma, d_context, type_context, prior_K, mixture_expectations):
    ...
    ############################### MAIN CONFIG  ############################### 
    print('{}-armed Contextual Linear Gaussian mixture bandit with optimal and sampling policies with MCMC and Variational inference for {} time-instants and {} realizations'.format(A, t_max, R))
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Evaluate Contextual Linear Gaussian Mixture Bandits: MCMC and Variational inference with sampling policy.')
