...
def main(K, t_max, R, theta_diff):
    ...
    for theta in combinations(np.arange(0,1.0,theta_diff),K):
        ...
        n_M_combinations=np.array([(1,100), (1,1000), (10,100), (10,1000), (50,100), (50,1000), (100,100), (100,1000)])
        for n_M in n_M_combinations:
            # sampling size
            sampling={'type':'static', 'n_samples':n_M[0]}
            bandits.append(BayesianBanditSamplingMonteCarlo(K, reward_function, reward_prior, sampling, n_M[1]))
            bandits_labels.append('MC n={},M={}'.format(n_M[0], n_M[1]))
